            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        window.location.href = "<?php echo base_url('absensi/hapus_absensi/')?>" + id;
                    });
                }
            });
        }
    ...
    <a href="<?php echo base_url('absensi/') ?>" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
      ...
      <div id="content" role="main">
        <header class="flex justify-between items-center p-4 bg-white border-b-2 border-gray-200">
            <h1 class="text-4xl">REKAP HARIAN </h1>
     ...
     <br>
         ...
         <div class="row">
            <table class="table table-striped">
                ...
                <tbody>
                <?php $no=0; foreach ($absensi_harian as $waifu): $no++ ?>
                            <tr class="whitespace-nowrap">
                                <td class="px-3 py-4 text-sm text-gray-500"><?php echo $no ?></td>
                                <td class="px-3 py-4">
                                    <div class="text-sm text-gray-900">
                                        <?php echo $waifu['kegiatan']; ?>
                                    </div>
                                </td>
                                <td class="px-3 py-4">
                                    <div class="text-sm text-gray-900">
                                ...
                                <td class="px-3 py-4">
                                    <div class="text-sm text-gray-900">
                                        <?php echo $waifu['jam_masuk']; ?>
                                    </div>
                                </td>
                                <td class="px-3 py-4">
                                    <div class="text-sm text-gray-900">
                                        <?php echo $waifu['jam_keluar']; ?>
                                    </div>
                                </td>
                                <td class="px-3 py-4">
                                    <div class="text-sm text-gray-900">
                                        <?php echo $waifu['keterangan_izin']; ?>
                                    </div>
                                </td>
                            </tr>
